...
def compute_mlm(pl_module, batch):
    ...
    mlm_loss = F.cross_entropy( # 13. Compute cross entropy loss using predicted logits for text feature and ground truth labels  
...
def compute_itm_wpa(pl_module, batch): # 
    ...
    ########################15. replace aligned image with a different image with the probability of 0.5 ##############
    ...
    #############################17.Compute loss (ITM loss, ot loss (approximate Wasserstein distance * 0.1) )#####
